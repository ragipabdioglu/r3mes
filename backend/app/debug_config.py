"""
Debug Configuration System for R3MES Backend
...
@dataclass
class DebugConfig:
    """Debug configuration for the backend component"""
    ...
    def is_backend_enabled(self) -> bool:
        """Check if debug is enabled for backend component"""
        return self.is_component_enabled("backend")
