...
impl Default for MinerConfig {
    fn default() -> Self {
        Self {
            ...
            blockchain_rpc: "http://localhost:26657".to_string(),
...
impl LauncherConfig {
    ...
    pub fn load() -> Self {
        ...
        let (default_chain_id, default_rpc, default_grpc, default_rest, default_ipfs, default_dashboard) = 
            if network_mode == "mainnet" {
                (
                    ...
                    "http://localhost:5001", // IPFS stays local
                    "https://r3mes.network",
                )
            } else {
                // Default to testnet
                (
                    "remes-testnet-1",
                    "https://testnet-rpc.r3mes.network",
                    "testnet-rpc.r3mes.network:9090",
