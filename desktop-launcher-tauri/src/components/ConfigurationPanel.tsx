...
export default function ConfigurationPanel({ isOpen, onClose }: ConfigurationPanelProps) {
  ...
  // Miner Config State
  const [minerConfig, setMinerConfig] = useState<MinerConfig>({
    wallet_address: "",
              ...
              <div className="form-row">
                ...
                <div className="form-group half">
                  ...
                  <select
                    ...
                    onChange={(e) => setMinerConfig({ ...minerConfig, log_level: e.target.value })}
                  >
                ...
                <div className="preset-buttons">
                  ...
                  <button
                    ...
                    onClick={() => setNetworkConfig({
                      ...
                      rpc_endpoint: "https://rpc.testnet.r3mes.network",
                      rest_endpoint: "https://api.testnet.r3mes.network",
                      grpc_endpoint: "grpc.testnet.r3mes.network:9090",
                      websocket_endpoint: "wss://rpc.testnet.r3mes.network/websocket",
                    })}
                  >
                    Testnet
                  </button>
            ...
            <div className="config-section">
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setAdvancedConfig({ ...advancedConfig, update_channel: e.target.value })}
                >
